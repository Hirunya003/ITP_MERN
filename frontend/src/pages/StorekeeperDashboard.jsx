    ...
    if (activeTab === 'inventory') {
          ...
          <div className="flex flex-wrap items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3 mt-2 md:mt-0">
              ...
              <div className="flex border rounded-lg overflow-hidden">
                ...
                <button
                  className={`p-2 ${viewType === 'list' ? 'bg-yellow-600 text-white' : 'bg-gray-100 text-gray-600'}`}
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-lg shadow-md">
              {searchTerm ? (
                ...
                <>
                  <p className="text-gray-500 mb-2">No products in inventory yet</p>
                  <button
                    onClick={() => setShowAddForm(true)}
                    className="text-yellow-600 hover:text-yellow-700"
                  >
      ...
      return (
        <div className="p-6 bg-white rounded-lg shadow-lg">
          ...
          <div className="mb-4">
            <p className="text-gray-700">Total Products: {summaryStats.totalProducts}</p>
            <p className="text-gray-700">Total Items: {summaryStats.totalItems}</p>
            <p className="text-gray-700">Low Stock Items: {summaryStats.lowStockCount}</p>
            <p className="text-gray-700">Categories: {summaryStats.categories}</p>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left text-sm font-medium text-gray-600">Min Stock</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
            ...
            <div className="bg-white p-4 rounded-lg border shadow-md">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{summaryStats.lowStockCount}</p>
                </div>
              </div>
            </div>
