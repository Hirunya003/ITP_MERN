        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <Link to="/cart" className="flex items-center justify-center hover:bg-green-700 rounded-full w-10 h-10 transition-all duration-200">
            ...
            {user ? (
              <div className="relative ml-2">
                ...
                >
                  ...
                  <FiChevronDown className={`transition-transform duration-200 ${dropdownOpen ? 'transform rotate-180' : ''}`} />
                </button>
